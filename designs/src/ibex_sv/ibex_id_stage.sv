...
module ibex_id_stage #(
  ...
  output logic [31:0]               branch_update_pc_o,
  output logic                      branch_update_taken_o,
  ...
  // Dynamic branch predictor feedback signals
  assign branch_update_valid_o = branch_in_dec & instr_executing & (id_fsm_q == FIRST_CYCLE);
//  assign branch_update_valid_o = branch_set;
  assign branch_update_pc_o    = pc_id_i;
  assign branch_update_taken_o = branch_decision_i;
