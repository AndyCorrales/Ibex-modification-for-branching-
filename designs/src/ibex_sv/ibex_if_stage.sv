...
module ibex_if_stage import ibex_pkg::*; #(
  ...
  parameter bit     DynamicBranchPredictor = 1'b0,
  ...
  input  logic                        branch_update_valid_i,
  input  logic [31:0]                 branch_update_pc_i,
  input  logic                        branch_update_taken_i,
...
`endif
  ...
  if (BranchPredictor) begin : g_branch_predictor
    ...
    if (DynamicBranchPredictor) begin : g_dynamic_predictor
      ibex_branch_predict_dynamic branch_predict_i (
        .clk_i                   (clk_i),
        .rst_ni                  (rst_ni),
        ...
        .branch_update_valid_i   (branch_update_valid_i),
        .branch_update_pc_i      (branch_update_pc_i),
        .branch_update_taken_i   (branch_update_taken_i)
      );
    end else begin : g_static_predictor
