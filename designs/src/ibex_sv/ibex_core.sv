...
module ibex_core import ibex_pkg::*; #(
 // =========================
  ...
  parameter rv32m_e                 RV32M            = ibex_pkg::RV32MSingleCycle,     // 1-cycle multiplier
  parameter rv32b_e                 RV32B            = ibex_pkg::RV32BFull,     // B extension activo
  ...
  parameter bit                     DynamicBranchPredictor      = 1'b1,

  // =========================
  // CACHE (OFF en esta config)
  // =========================
...
`ifdef RVFI
  ...
  ibex_if_stage #(
    ...
    .branch_update_valid_i (branch_update_valid),
    .branch_update_pc_i    (branch_update_pc),
    .branch_update_taken_i (branch_update_taken),
  ...
  ibex_id_stage #(
    ...
    .branch_update_pc_o    (branch_update_pc),
    .branch_update_taken_o (branch_update_taken),
